...
const projects = [
    {
        ...
        description: "A command-line Java application with tasks, reminders, priority, and undo functionality.",
        link: "https://github.com/AnthonySoltvedt/To-do-list-applications",
        tech: ["Java", "CLI", "ArrayList", "PriorityQueue"]
    },
    {
        title: "BBJ Tracker App",
        description: "A tracker app for logging BBJ sessions, progress, and personal routines.",
        link: "https://github.com/AnthonySoltvedt/bjj_tracker.by.git",
        tech: ["Python", "Android", "SQLite"]
    },
    {
...
const uniProjects = [
    {
        ...
        description: "Built a prototype application that processes and reshapes data from a provided dataset to generate specific outputs. Focused on data transformation, formatting, and structured output generation using modular program design.",
    ...
    },
    {
        ...
        description: "Built a data mining application that cleans and analyses rental housing data using regression and classification techniques to identify key problem areas related to rent increases and generate targeted insights.",
        ...
        tech: ["Python", "Pandas", "Regression", "Classification"]
    },
];
...
function App() {
    return (
        <>
            {/* HEADER */}
            <header style={{ padding: "20px", background: colors.headerBg, color: colors.textLight, textAlign: "center" }}>
            ...
            {/* ABOUT ME */}
            <div id="about-me" style={{ fontFamily: "Arial, sans-serif", padding: "40px", background: colors.mainBg, textAlign: "center" }}>
            ...
            {/* CONTACT */}
            <div id="contacts" style={{ fontFamily: "Arial, sans-serif", padding: "40px", background: colors.mainBg, textAlign: "center" }}>
                <h1 style={{ color: colors.accent, marginBottom: "20px" }}>Contact</h1>
                <p style={{ color: colors.text, marginBottom: "10px" }}>
                    Email: <a href="mailto:anthonysoltvedt1996@gmail.com" style={{ color: colors.accent, textDecoration: "none", fontWeight: "bold" }}>anthonysoltvedt1996@gmail.com</a>
                </p>
                <p style={{ color: colors.text, marginBottom: "10px" }}>
            ...
            {/* FOOTER */}
            <footer style={{ padding: "20px", textAlign: "center", background: colors.footerBg, color: colors.footerText }}>
